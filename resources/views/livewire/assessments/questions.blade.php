            ...
            <div class="max-w-4xl mx-auto px-4">
                ...
                <div class="text-center">
                    ...
                    <p class="mt-2 text-sm text-gray-500">
                        {{ __('assessments.subtitle') }}
                    </p>
                </div>

                <div class="mt-6 flex items-center justify-between text-sm text-gray-500">
                    <span>{{ __('assessments.progress') }}</span>
                    ...
                    @foreach ($questions as $index => $question)
                        <div class="rounded-xl border border-gray-100 bg-white p-5 shadow-sm">
                            ...
                            <div class="mt-4 flex flex-wrap gap-2">
                                @foreach (trans('assessments.options') as $value => $label)
                                    @php
    ...
    @guest
        <section class="bg-gradient-to-b from-teal-50 to-white py-20">
            <div class="text-center max-w-3xl mx-auto">
                <h1 class="text-3xl font-bold text-gray-900">{{ __('assessments.login_title') }}</h1>
                <p class="text-gray-600 mt-4">{{ __('assessments.login_subtitle') }}</p>
